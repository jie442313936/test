	...
	<view class="zai-box">
		...
		<view class="zai-form">
			<form @submit="formSubmit">
				...
				<input name="repassword" class="zai-input" placeholder-class password placeholder="请再输入一次密码" />
				<button form-type="submit" class="zai-btn">立即注册</button>
